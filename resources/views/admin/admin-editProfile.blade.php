                    ...
                    <form enctype="multipart/form-data" method="POST" action="{{ route('update.profile', ['id' => $user->id]) }}">
                        ...
                        <div class="items-center mt-8 text-[#202142]">
                            ...
                            <div class="flex flex-col items-center w-full mb-2 space-x-0 space-y-2 sm:flex-row sm:space-x-4 sm:space-y-0 sm:mb-6">
                                <div class="w-full">
                                    <label for="fname" class="block mb-2 text-sm font-medium text-indigo-900 ">First Name</label>
                                    <input type="text" id="fname" name="fname" class="bg-indigo-50 border border-indigo-300 text-indigo-900 text-sm rounded-lg focus:ring-indigo-500 focus:border-indigo-500 block w-full p-2.5" placeholder="First name" value="{{$user->first_name}}" required>
                                </div>
                                <div class="w-full">
                                    <label for="lname" class="block mb-2 text-sm font-medium text-indigo-900 ">Last Name</label>
                                    <input type="text" id="lname" name="lname" class="bg-indigo-50 border border-indigo-300 text-indigo-900 text-sm rounded-lg focus:ring-indigo-500 focus:border-indigo-500 block w-full p-2.5" placeholder="Last name" value="{{$user->last_name}}" required>
                                </div>
                            </div>

                            <!-- Address Input -->
                            <div class="mb-2 sm:mb-6">
                                <label for="address" class="block mb-2 text-sm font-medium text-indigo-900 ">Address</label>
                                <input type="text" id="address" name="address" class="bg-indigo-50 border border-indigo-300 text-indigo-900 text-sm rounded-lg focus:ring-indigo-500 focus:border-indigo-500 block w-full p-2.5" placeholder="Address" value="{{$user->address}}" required>
                            </div>
                            ...
                            <!-- Role Dropdown -->
                            <div class="mb-2 sm:mb-6">
                                <label for="role" class="block mb-2 text-sm font-medium text-indigo-900">Role</label>
                                <select id="role" name="role" class="bg-indigo-50 border border-indigo-300 text-indigo-900 text-sm rounded-lg focus:ring-indigo-500 focus:border-indigo-500 block w-full p-2.5" required onchange="handleRoleChange();">
                            ...
                            <!-- Category Dropdown for Workers -->
                            <div id="categoryDropdown" class="mb-2 sm:mb-6" style="{{ $user->role == 'worker' ? 'display: block;' : 'display: none;' }}">
                                <label for="category" class="block mb-2 text-sm font-medium text-indigo-900">Category</label>
                                <select id="category" name="category" class="bg-indigo-50 border border-indigo-300 text-indigo-900 text-sm rounded-lg focus:ring-indigo-500 focus:border-indigo-500 block w-full p-2.5">
                            ...
                            <!-- Verification Dropdown for Users -->
                            <div id="verifiedDropdown" class="mb-2 sm:mb-6" style="{{ $user->role == 'user' ? 'display: block;' : 'display: none;' }}">
                                <label for="verified" class="block mb-2 text-sm font-medium text-indigo-900">Verified</label>
                                <select id="verified" name="verified" class="bg-indigo-50 border border-indigo-300 text-indigo-900 text-sm rounded-lg focus:ring-indigo-500 focus:border-indigo-500 block w-full p-2.5">
                            ...
                            <div class="flex justify-end">
                                <button type="submit" class="text-white mt-2 bg-blue-400 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-indigo-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-indigo-600 dark:hover:bg-indigo-700 dark:focus:ring-indigo-800">
                                    Save Changes
                                </button>
                            </div>
                        </div>
...
<!-- JavaScript for handling role-specific dropdowns -->
<script>
