            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                ...
                <div class="bg-white border border-gray-200 shadow-md shadow-black/5 p-6 rounded-md">
                    ...
                    <form action="" class="flex items-center mb-4">
                        <div class="relative w-full mr-2">
                            <input type="text" class="py-2 pr-4 pl-10  w-full outline-none border border-gray-200 rounded-md text-sm focus:border-blue-500" placeholder="Search...">
                            <i class="ri-search-line absolute top-1/2 left-4 -translate-y-1/2 text-gray-800"></i>
                        </div>
                        <select class="text-sm py-2 pl-4 pr-10 border bg-gray-200 border-gray-200 rounded-md focus:border-blue-500 outline-none appearance-none bg-select-arrow bg-no-repeat bg-[length:16px_16px] bg-[right_16px_center]">
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full min-w-[540px]">
                            <thead>
                                <tr>
                                    <th class="text-[12px] uppercase tracking-wide font-medium text-gray-800 py-2 px-4 text-left rounded-tl-md rounded-bl-md">Name</th>
                                    <th class="text-[12px] uppercase tracking-wide font-medium text-gray-800 py-2 px-4 text-left">File Type</th>
                                    <th class="text-[12px] uppercase tracking-wide font-medium text-gray-800 py-2 px-4 text-left">Time</th>
                                    <th class="text-[12px] uppercase tracking-wide font-medium text-gray-800 py-2 px-4 text-left rounded-tr-md rounded-br-md"></th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                    <td class="py-2 px-4 border-b border-b-gray-300">
                                        <div class="flex items-center">
                                            ...
                                            <a href="#" class="text-gray-800 text-sm font-medium hover:text-blue-500 truncate">User No.1 Application for Job Seeking</a>
                                        </div>
                                    </td>
                                    <td class="py-2 px-4 border-b border-b-gray-300">
                ...
                <div class="bg-white border border-gray-200 shadow-md shadow-black/5 p-6 rounded-md">
                    ...
                    <form action="" class="flex items-center mb-4">
                        ...
                        <select class="text-sm py-2 pl-4 pr-10 bg-gray-200 border border-gray-200 rounded-md focus:border-blue-500 outline-none appearance-none bg-select-arrow bg-no-repeat bg-[length:16px_16px] bg-[right_16px_center]">
                            <option value="">All</option>
                    ...
                    <div class="overflow-x-auto overflow-y-auto">
                        <table class="w-full min-w-[540px]">
                            <thead>
                                <tr>
                                    <th class="text-[12px] uppercase tracking-wide font-medium text-gray-800 py-2 px-4 text-left rounded-tl-md rounded-bl-md">User</th>
                                    <th class="text-[12px] uppercase tracking-wide font-medium text-gray-800 py-2 px-4 text-left">Subject</th>
                                    <th class="text-[12px] uppercase tracking-wide font-medium text-gray-800 py-2 px-4 text-left">Time</th>
                                    <th class="text-[12px] uppercase tracking-wide font-medium text-gray-800 py-2 px-4 text-left rounded-tr-md rounded-br-md"></th>
                                </tr>
                            </thead>
                                ...
                                <tr>
                                    <td class="py-2 px-4 border-b border-b-gray-300">
                                        <div class="flex items-center">
                                            ...
                                            <a href="#" class="text-gray-600 text-sm font-medium hover:text-blue-500 ml-2 truncate">John Doe</a>
                                        </div>
                                    </td>
                                    <td class="py-2 px-4 border-b border-b-gray-300">
