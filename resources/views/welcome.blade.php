            ...
            <div class="max-w-6xl px-4 mx-auto">
                <nav class="flex items-center justify-between py-4">
                    ...
                    <div class="flex justify-between lg:space-x-2">
                        ...
                        @else
                            <a href="{{ route('login') }}"
                                class="inline-block text-gray-900 hover:text-blue-500 text-sm font-medium">Log In</a>
                            <span class="text-sm font-medium px-1">/</span>
                        @endauth
                        <a href="{{ route('register') }}"
                            class="inline-block text-gray-900 hover:text-blue-500 text-sm font-medium ">Register</a>
                            ...
                            <form>
                                <div class="ContentLeft2 searchbox relative flex">
                                    {{-- <input type="text" name="search"
                                        class="flex flex-1 bg-white rounded-md justify-center items-center border-blue-500 gap-2 px-5 py-4 sm:w-96 sm:py-3 w-full border text-lg">
