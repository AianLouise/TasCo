...
==
    ...
    {{-- Content --}}
    <section class="flex z-40 justify-center items-center mt-5 max-w-full">
    <div class="bg-white border border-gray-100 shadow-md shadow-black/5 p-5 md:w-1/2 w-full rounded-md lg:px-4 ">   
        <div class="pl-4 grid grid-cols- justify-center ">
            <span class="titleinfo text-2xl pb-2 pt-2">Activity Log</span>
        </div>
        <table class="w-full mt-4 overflow-scroll">
            <thead>
                <tr>
