    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="p-4">
            ...
            <div class="flex items-center justify-center "> <!-- Center the button horizontally and vertically -->
                <button
                    class="bg-blue-500 hover:bg-blue-700 text-white font-semibold py-2 w-full border border-blue-700 rounded mt-5">Register</button>
            </div>

            <div class="flex items-center justify-center">
                <a class="bg-transparent text-blue-500 font-semibold hover:text-blue-500 py-2 px-54 border border-blue-500 rounded mt-3 w-full mb-5 text-center"
