    ...
    <div class="p-4 sm:p-8"> <!-- Padding adjustments for small screens -->
        <form method="POST" action="{{ route('login') }}">
            ...
            <div class="relative mb-5">
                <x-text-input id="email" placeholder="Email" class="pl-12 py-2 w-full" type="email" name="email" :value="old('email')" required autofocus autocomplete="username" />
            ...
            <!-- Password -->
            <div class="relative mb-5">
                <x-text-input id="password" placeholder="Password" class="pl-12 py-2 w-full" type="password" name="password" required autocomplete="current-password" />
