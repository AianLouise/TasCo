    ...
    <main class="bg-blue-50">
                                ...
                                <tr class="border-b">
                                    ...
                                    <td
                                        ...
                                        <button class="text-green-500"
                                            onclick="approveApplication({{ $hiringForm->id }})">Approve</button>
                                        <span>/</span>
                                        <button class="text-red-500"
                                            onclick="rejectApplication({{ $hiringForm->id }})">Reject</button>
                                    </td>
        ...
        <script>
            function approveApplication(formId) {
                // Implement your logic for approving the application
                console.log('Approving application with ID: ' + formId);
            }
        
            function rejectApplication(formId) {
                // Implement your logic for rejecting the application
                console.log('Rejecting application with ID: ' + formId);
            }
        </script>
